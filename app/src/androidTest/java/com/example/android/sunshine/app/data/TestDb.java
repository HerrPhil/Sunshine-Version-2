...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        Cursor dbCursor = db.query(WeatherContract.WeatherEntry.TABLE_NAME,
                null, // all columns
        ...
        assertTrue("Error: no records returned from weather query", dbCursor.moveToFirst());

        // Validate data in resulting Cursor with the original ContentValues
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("bad", dbCursor, testValues);

        assertFalse("Error: More than one record returned from the location query", dbCursor.moveToNext());
