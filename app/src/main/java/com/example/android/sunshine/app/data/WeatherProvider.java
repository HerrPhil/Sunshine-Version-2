...
//        uriMatcher.addURI(WeatherContract.CONTENT_AUTHORITY,WeatherContract.WeatherEntry.CONTENT_URI.toString(),WEATHER);
        ...
        uriMatcher.addURI(authority,WeatherContract.PATH_WEATHER.concat("/*").concat("/#"),WEATHER_WITH_LOCATION_AND_DATE);
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        // This makes delete all rows return the number of rows deleted; cool, good to know
